...
<head>
    <meta charset="utf-8">
    <title>Home Gym Equipment- Contact Page</title>
                        ...
                        <form>
                            ...
                            <div class="form-row">
                                <div class="control-group col-sm-6">
                                    <input type="text" class="form-control p-4" id="name" placeholder="Your Phone"
                                        required="required"
                                        data-validation-required-message="Please enter your phone number" />
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="control-group col-sm-6">
                                    <input type="email" class="form-control p-4" id="email" placeholder="Yor Email"
                                        required="required"
                            ...
                            <div class="control-group">
                                <textarea class="form-control py-3 px-4" rows="5" id="message" placeholder="Message"
                                    required="required"
                                    data-validation-required-message="Please send us message"></textarea>
                                <p class="help-block text-danger"></p>
                                Agree to our <a style="color: darkblue;" href="privacy.php">privacy and policy?</a>
                            </div>
                            <div class="form-row">
                                <div class="control-group col-sm-3" style="text-align: right;">
                                    12+5=
                                </div>
                                <div class="control-group col-sm-1">
                                    <input type="number" class="form-control" name="robot" placeholder=""
                                        required="required"
                                        data-validation-required-message="Please enter the answer" />
                                </div>
                                <div class="control-group col-sm-1">
                                </div>

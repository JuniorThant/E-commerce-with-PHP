...
<head>
    <meta charset="utf-8">
    <title>Home Gym Equipment- Index Page</title>
            ...
            <nav class="navbar navbar-expand-lg bg-light navbar-light shadow-lg py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="infoindex.php" class="nav-item nav-link">Information</a>
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <a href="clogin.php" class="btn btn-primary py-md-3 px-md-5 mt-2">Book Now</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <a href="clogin.php"><button class="btn btn-primary btn-block py-3" name="btnShopNow" type="submit">
                        ...
                        <div class="owl-carousel testimonial-carousel">
                            <div class="text-center pb-4">
                                ...
                                <div class="testimonial-text bg-white p-4 mt-n5">
                                    <p class="mt-5">
                                        I love this repair service. I bought running machine from this website and it
                                        broke the battery system after three years. Thus, I called the repair service
                                        and they fixed it in a day.
                                    </p>
                                    <h5 class="text-truncate">Jerry</h5>
                            ...
                            <div class="text-center">
                                <img class="img-fluid mx-auto" src="img/testimonial-2.jpg"
                                    style="width: 100px; height: 100px;">
                                <div class="testimonial-text bg-white p-4 mt-n5">
                                    <p class="mt-5">This shop sells good quality equipment. Althought I bought the
                                        second hand product, it barely broke. I really recommend this shop.
                                    </p>
                                    <h5 class="text-truncate">Monica</h5>
                            ...
                            <div class="text-center">
                                <img class="img-fluid mx-auto" src="img/testimonial-3.jpg"
                                    style="width: 100px; height: 100px;">
                                <div class="testimonial-text bg-white p-4 mt-n5">
                                    <p class="mt-5">This shop sells a lot of new and second hand products with good
                                        qualities. I really like this shop.
                                    </p>
                            ...
                            <div class="text-center">
                                <img class="img-fluid mx-auto" src="img/testimonial-4.jpg"
                                    style="width: 100px; height: 100px;">
                                <div class="testimonial-text bg-white p-4 mt-n5">
                                    <p class="mt-5">I would like to recommend this due to good and reliable services. If
                                        you buy equipment from this store, you do not need to worry for maintenance and
                                        repair matters.
                                    </p>
                                    <h5 class="text-truncate">Breakley</h5>
                ...
                <div class="cookie-container">
                    <p>We use cookies in this website. To accept our <a href="#">privacy<a> and <a href="#">policy</a>
                                in website, click accept button.</p>

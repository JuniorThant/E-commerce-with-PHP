...
if (isset($_REQUEST['FProductID'])) {
    $productid = $_REQUEST['FProductID'];
    $query = "SELECT * FROM FProduct
            WHERE FProductID='$productid'";
    $run = mysqli_query($connect, $query);
    $arr = mysqli_fetch_array($run);

    $ProductID = $arr['FProductID'];
    $ProductName = $arr['FProductName'];
    $Price = $arr['FPrice'];
    $Quantity = $arr['FQuantity'];
                                ...
                                <div class="bg-white mb-3" style="padding: 30px;">
                                    <div class="d-flex mb-3">
                                        ...
                                        <div class="col-lg-3 col-md-6 mb-4">
                                            ...
                                            <br>
                                            <br>
                                            <p> <a href="fshoppingcart.php?CustomerID=$CustomerID"><input

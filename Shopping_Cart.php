        ...
        <div class='container py-3'>
                        ...
                        <div class='col-lg-6 col-md-6 mb-4'>
                            ...
                            <p><small>$BuyQty pcs ordered from $Price $</small></p>
                                ...
                                <br>
                                <br>
                                <p><button class='btn btn-primary py-3 px-4'><a style='color:white;' href='Shopping_Cart.php?ProductID=$ProductID&Action=Remove'>Remove</a></button></p>
                                </div>
                                </div>"
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    ...
                    <div class="d-flex flex-column text-center bg-white mb-5 py-5 px-4">
                        ...
                        <button class='btn btn-primary py-3 px-2'><a style="color: white;"
                                href="wanted.php">Continue</a></button></p><br>
                        <p> &nbsp &nbsp<button class='btn btn-primary py-3 px-2'><a style="color: white;"
                                    href="payment.php">Make Payment</a></button>&nbsp &nbsp</p>
                    </div>
                </div>
            </div>
        </div>

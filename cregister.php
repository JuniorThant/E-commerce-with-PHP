...
// $shfl=str_shuffle($password);
// $pwd=substr($shfl, 0,8);
//-----------------Image Upload------------------//
    // $image=$_FILES['filecustomerimage']['name'];
    // $folder="ImageDW1/";
    // $filename=$folder.'_'.$image;
    // $image=copy($_FILES['filecustomerimage']['tmp_name'],$filename);
    // if(!$image)
    // {
...
//----------------------------------------//
    ...
    if ($count > 0) {
        echo "<script>alert('Your email or password has been used, Please Try again!')</script>";
        echo "<script>window.location='cregister.php'</script>";
    } else {
        $insert = "INSERT INTO Customer(CustomerName,CustomerEmail,CustomerPassword,CustomerPhone,CustomerAddress,PostalCode,ViewCount)
        values('$customername','$email','$password','$phone','$address','$postal',0)";
        $query = mysqli_query($connect, $insert);

        if ($query) {
            echo "<script>alert('Customer Register Successful')</script>";
...
<head>
    <meta charset="utf-8">
    <title>Home Gym Equipment- Customer Register Page</title>
    ...
    <div class="container-fluid page-header">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-4 text-white text-uppercase">Customer Register</h3>
                <div class="d-inline-flex text-white">
                    <p class="m-0 text-uppercase"><a class="text-white" href="">Home</a></p>
                    <i class="fa fa-angle-double-right pt-1 px-3"></i>
                    <p class="m-0 text-uppercase">Customer Register</p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="bg-white" style="padding: 30px;">
                        ...
                        <form action="cregister.php" method="POST">
                            <div class="col-lg-12">
                                    ...
                                    <div class="card-body rounded-bottom bg-white p-5">
                                        <form action="cregister.php" method="POST">
                                            <div class="form-group">
                                                <input type="text" name="txtcustomername" class="form-control p-4"
                                                    placeholder="Your name" required="required" />
                                            </div>


                                            <div class="form-group">
                                                <input type="number" name="txtphone" class="form-control p-4"
                                                    placeholder="Your phone number" required="required" />
                                            </div>
                                            <div class="form-group">
                                                <textarea type="text" name="txtaddress" class="form-control p-4"
                                                    placeholder="Your address" required="required"></textarea>
                                            </div>
                                            <div class="form-group">
                                                <input type="number" name="txtpostal" class="form-control p-4"
                                                    placeholder="Your postal code" required="required" />
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="input-group-text">
                                                <label>
                                                    <input type="checkbox" class="input-group-text"
                                                        ...
                                                        required="required"> I'm not a robot<img width="30px"
                                                        height="30px"
                                            ...
                                            <a style="color: darkblue;" href="clogin.php">Already have an account? Login
                                                now!</a>
                                ...
                                <div>
                                    <button class="btn btn-primary btn-block py-3" name="btnSignIn" type="submit">Sign
                                        Up</button>
                                </div>
                        </form>
                    </div>

...
<head>
    <meta charset="utf-8">
    <title>Home Gym Equipment- Gallery Page</title>
...
<body>
    ...
    if ($count == 0) {
        ...
        <div class='container pt-5 pb-3'>
            ...
            <div class='row'>";
        for ($i = 0; $i < $count; $i += 5) {
            $query1 = "SELECT * FROM Product where ProductTypeID=1  ORDER BY ProductID LIMIT $i,5";
            ...
            for ($a = 0; $a < $count1; $a++) {
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        <img class="img-fluid" src="ImageDW1/<?php echo $Image1 ?>" alt="">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="service-item text-center mb-2 py-5 px-4">
                        <img class="img-fluid" src="ImageDW1/rss.png" width="100px" height="100px" alt=""> Subscribe to
                        this feed
